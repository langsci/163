...
There are two big camps in linguistics: the Chomskyan research tradition
...
Within the Chomskyan research
tradition \emph{Lectures on Government \& Binding} was very influential \citep{Chomsky81a}. It initiated a lot of research, both
...
in Figure~\ref{fig-Anna-reads-the-book-flat-CxG} is a completely flat structure as assumed by Croft and the one in Figure~\ref{fig-Anna-reads-the-book-VP} is an
...
\citet*{AGT2014a} develop the respective phrasal analysis of the benefactive construction.
  ...
  The approach of \citet{AGT2014a} could be seen as a way to formalize phrasal constructional
...
\rulenode{V\\* \up~=~\down}
\rulenode{DP\\*(\up\ \obj) = \down}
\rulenode{\{ DP|AP|PP \}\\*(\up\ \xcomp) = \down\\*(\down \subjlfg) = (\up \obj)\\*\hspace{-3em}@RESULT-T((\up PRED FN)) }\hspace{-2ex}
}
\z
...
verbs probably would\todostefan{or \emph{would probably}?} be represented as intransitive in the lexicon with an optional semantic
...
environments get genitive, as in (\mex{0}c)\todostefan{like in ...?}. Nothing special has to be stipulated in the lexical
approach.
...
g in (\mex{1}a), Sandy is the \argtwo in (\mex{1}b). Godzilla is \argthree in
(\mex{1}b).\todostefan{italics for godzilla usw.?}
\eal
\ex 
\begin{tabular}[t]{@{}l@{}}
...
\glt `the man who fishes the pond empty'\todostefan{who fishes out the pond}
\ex 
